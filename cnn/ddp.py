...
def main(): 
    ...
    train_file_paths = [f'/home/dp332/dp332/dc-su2/dc-su2/Rotation/train_{i}.hdf5' for i in range(87)]
    test_file_paths = [f'/home/dp332/dp332/dc-su2/dc-su2/Rotation/test_{i}.hdf5' for i in range(22)]
    ...
    # Use GPU
        ...
        # Use CPU
        map_location = 'cpu'
    model_dic = '/home/dp332/dp332/dc-su2/results/rotation/intermediate/model_39.pth'
