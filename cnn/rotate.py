...
# file paths for train, vali and test
file_statistics = '/home/dc-su2/physical_informed/cnn/rotate/statistics.pkl'
file_paths = [f'/home/dc-su2/rds/rds-dirac-dp147/vtu_oldmodels/Magritte-examples/physical_forward/cnn/Batches/batch_{i}.hdf5' for i in range(10)]
train_file_path = file_paths[:8]
vali_file_path  = file_paths[8:9]
test_file_path  = file_paths[9:]
...
def loss_object(target,pred):
    mse_loss = nn.functional.mse_loss(target, pred)
    freq_loss_scale = 1.0
...
def main():
    ...
    with open("/home/dc-su2/physical_informed/cnn/original/results/mse_ffl_history.pkl", "wb") as pickle_file:
        pickle.dump(data, pickle_file)
    torch.save(model,'/home/dc-su2/physical_informed/cnn/original/results/mse_ffl_model.pth')
    ...
    for i in range(0,600,50):
        ...
        plt.savefig('/home/dc-su2/physical_informed/cnn/original/results/img/ffl_ex{}.png'.format(i))
        plt.close()
